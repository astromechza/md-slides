...
<!DOCTYPE html>
  ...
  <body>
    ...
    <div class="page-wrap">
    <div class="slide-wrap slide-wrap-halign-{{ .Settings.HAlign }} slide-wrap-valign-{{ .Settings.VAlign }} slide-wrap-talign-{{ .Settings.TAlign }}" style="width: {{ .Settings.XResPX }}px; left: {{ .PageLeft }}px; top: {{ .PageTop }}px; height: {{ .Settings.YResPX }}px; color: {{ .Settings.FontColor }}; transform: scale({{ .Scale }})">
